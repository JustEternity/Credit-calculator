...
"}")
        ...
        self.rate_enter.setMaximumSize(QtCore.QSize(120, 25))
        font = QtGui.QFont()
        font.setPointSize(11)
...
"}")
        ...
        self.rate_enter.setClearButtonEnabled(True)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.enter_sum.setText(_translate("MainWindow", "0"))
        ...
        self.rate_enter.setText(_translate("MainWindow", "0.0"))
        self.label_term.setText(_translate("MainWindow", "Срок кредита"))
        self.enter_term.setText(_translate("MainWindow", "0"))
